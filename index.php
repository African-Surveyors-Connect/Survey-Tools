<?php include('includes/header.php');?>
        ...
        <div class="container-fluid" style="text-align:center;">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="#" class="d-none d-sm-inline-block btn-sm btn-primary shadow-sm"><i class="fas fa-share fa-sm text-white-50"></i>Share Web App</a>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-xl-4 col-lg-5">
              <div class="card shadow mb-4">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Todays Word</h6>
                  <div class="dropdown no-arrow">
                    <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                      <div class="dropdown-header">Surveyors Dictionary:</div>
                      <a class="dropdown-item" href="#">Search Word</a>
                      <a class="dropdown-item" href="#">Add Word</a>
                      <div class="dropdown-divider"></div>
                      <a class="dropdown-item" href="#">Report bias</a>
                    </div>
                  </div>
                </div>
                <!-- Card Body -->
