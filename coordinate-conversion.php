...
<td><input type=text size=15 name="txtLongitude" value="" class="InputBox"></td>
<td align=center>
    <button class="btn" name="btnToUTM"  onClick="btnToUTM_OnClick ()" type="button"><i class="fas fa-hand-point-right"></i></button>
</td>
<td align=right>x (easting)</td>
<td><input type=text size=15 name="txtX" value="" class="InputBox"></td>
</tr>
...
<td><input type=text size=15 name="txtLatitude" value="" class="InputBox"></td>
<td align=center>
    <button class="btn" name="btnToGeographic" onClick="btnToGeographic_OnClick ()" type="button"><i class="fas fa-hand-point-left"></i></button>
</td>
<td align=right>y (Northing)</td>
<td><input type=text size=15 name="txtY" value="" class="InputBox"></td>
</tr>
...
<td><input type=text size=4 name="txtZone" value="" class="InputBox"></td>
</tr>
...
<td colspan=2>
    ...
    <input type=radio name="rbtnHemisphere" value="N" CHECKED OnClick="0" class="InputBox">N
