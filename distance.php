<?php require('header.php');?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Distance</h1>
          </div>

          <div class="row">
			  <div class="alert alert-primary" role="alert">
				  All the adjustments contained within require you to have a measurement value of length before attempting any of the adjustments. Make sure you enter the correct values before finalizing your calculation
			  </div>
